...
const inputClass =
  'w-full px-4 py-3 bg-dark/80 border border-silver/20 rounded-lg text-light text-sm ' +
  'placeholder:text-light/30 focus:outline-none focus:border-silver focus:ring-1 focus:ring-silver/30 transition-colors';
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-10">
          ...
          >
            ...
            >
              ...
              <span className="text-silver group-hover:text-silver-light transition-colors text-sm break-all">
                {portfolioData.email}
              </span>
            </a>
                ...
                {portfolioData.socials.map((social) => {
                  ...
                  return (
                    <a
                      ...
                      className="w-10 h-10 rounded-lg bg-silver/10 border border-silver/20 flex items-center justify-center text-silver hover:bg-silver/20 hover:text-silver-light transition-colors"
