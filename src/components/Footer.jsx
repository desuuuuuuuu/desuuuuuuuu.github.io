...
const Footer = () => {
  return (
    <footer className="bg-dark-3/90 border-t border-gold/10 pt-14 pb-8">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 mb-10">
          ...
          >
            <div className="flex items-center gap-2.5 mb-3">
              ...
              <h3 className="text-gold text-base font-bold">{portfolioData.brand}</h3>
            </div>
          ...
          >
            ...
            <ul className="space-y-2">
              {portfolioData.navLinks.slice(0, 5).map((link) => (
                <li key={link.href}>
                  <a href={link.href} className="text-muted hover:text-gold transition-colors text-xs">
                    {link.label}
                  </a>
                </li>
              ))}
              ...
              {portfolioData.socials.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-9 h-9 rounded-lg bg-gold/10 border border-gold/20 flex items-center justify-center text-muted hover:text-gold hover:bg-gold/15 transition-colors"
        ...
        <div className="pt-6 border-t border-gold/10 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <a
            href="#home"
            className="flex items-center gap-2 text-muted hover:text-gold transition-colors text-[11px] uppercase tracking-wider"
          >
